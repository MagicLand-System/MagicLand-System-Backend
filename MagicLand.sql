...
GO
CREATE DATABASE MagicLandDBServer;
GO
...
('08048a0b-7d2b-47de-9153-5fa23163aa3f', 'Admintrator', '0963245204','thuongmc2k2@gmail.com', 'MALE', '2023-11-17', null, '3c1849af-400c-43ca-979e-58c71ce9301d');
-- Parent 
Insert into [User] (Id, FullName, Phone, Email, Gender, DateOfBirth, AddressId, RoleId) Values
...
('7ab4f60d-5b04-4474-a891-eee0b4817541', 'VfvO1856oHM4hQxdJ0YMdbVubsEeiq', 20, 'PERCENTAGE', 10, '2023-12-17');
Insert into Promotion ( Id, Code, [Image], UnitDiscount, DiscountValue, EndDate) Values
('2f905f4f-432c-4d04-98b9-57daa89ceefa', 'Hlin2ab8EtBE6PktNBJQbA59qPq5rS', 20000, 'CASH', 10000, '2023-12-17');
...
GO
Insert into Course (Id, [Name], NumberOfSession, MinYearStudent, MaxYearStudent, [Status]) Values
...
Insert into Class (Id, [Name], CourseId, StartTime, EndTime,[Status], Method, LecturerId, Price, AddressId, LimitNumberStudent) Values
('57e926d1-c82b-41e1-9a43-c5b0d06b2016', 'Math with basic geometry', 'fded66d4-c3e7-4721-b509-e71feab6723a', '2023-11-25', '2024-01-25', 'UPCOMING', 'ONLINE', '66aa922d-4392-4958-bbef-fc9689c9779b', 100000,'efa2d425-b9ec-4e47-bbad-e445a587bbdd', 30);
Insert into Class (Id, [Name], CourseId, StartTime, EndTime, [Status], Method, LecturerId, Price, AddressId, LimitNumberStudent) Values
...
GO
Insert into ClassFeeTransaction (Id, ParentId, , ActualPrice) Values 
